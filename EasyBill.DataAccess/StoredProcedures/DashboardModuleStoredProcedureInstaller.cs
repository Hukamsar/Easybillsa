...
{
    public static class DashboardModuleStoredProcedureInstaller
    {
        private const string ResourceSuffix = "Sql.DashboardModule.StoredProcedures.sql";
        ...
        public static async Task EnsureInstalledAsync(ApplicationDbContext context, CancellationToken cancellationToken = default)
        {
            ...
            var assembly = typeof(DashboardModuleStoredProcedureInstaller).Assembly;
            ...
            {
                throw new InvalidOperationException("Embedded SQL resource for dashboard stored procedures was not found.");
            }
