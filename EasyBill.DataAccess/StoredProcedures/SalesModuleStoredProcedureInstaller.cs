...
{
    public static class SalesModuleStoredProcedureInstaller
    {
        private const string ResourceSuffix = "Sql.SalesModule.StoredProcedures.sql";
        ...
        public static async Task EnsureInstalledAsync(ApplicationDbContext context, CancellationToken cancellationToken = default)
        {
            ...
            var assembly = typeof(SalesModuleStoredProcedureInstaller).Assembly;
            ...
            {
                throw new InvalidOperationException("Embedded SQL resource for sales stored procedures was not found.");
            }
