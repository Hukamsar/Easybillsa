...
{
    public static class ItemMasterModuleStoredProcedureInstaller
    {
        private const string ResourceSuffix = "Sql.ItemMasterModule.StoredProcedures.sql";
        ...
        public static async Task EnsureInstalledAsync(ApplicationDbContext context, CancellationToken cancellationToken = default)
        {
            ...
            var assembly = typeof(ItemMasterModuleStoredProcedureInstaller).Assembly;
            ...
            {
                throw new InvalidOperationException("Embedded SQL resource for item master stored procedures was not found.");
            }
